...
class MatrixTest < Minitest::Test
  ...
  def test_output_matrix_rows
    matrix = Matrix.new("89 1903 3\n18 3 1\n9 4 800")
    assert_equal [[89, 1903, 3],[18, 3, 1],[9, 4, 800]], matrix.rows
  end

  def test_output_matrix_columns
    matrix = Matrix.new("89 1903 3\n18 3 1\n9 4 800")
    assert_equal [[89, 18, 9],[1903, 3, 4],[3, 1, 800]], matrix.columns
  end
end
